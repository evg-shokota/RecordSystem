...
`);
  ...
  var inputRegex2, pasteRegex, Code;
...
${nextLine.slice(indentLevel + 2)}`;
  ...
  var inputRegex4, pasteRegex2, Strike;
  ...
  var CharacterCount, Dropcursor, Focus, Gapcursor, DEFAULT_DATA_ATTRIBUTE, Placeholder, Selection2, TrailingNode, UndoRedo;
...
`;
  ...
  var TableCell, TableHeader, TableRow, TableView2, deleteTableWhenAllCellsSelected, DEFAULT_CELL_LINE_SEPARATOR, markdown_default, Table, TableKit;
  var init_dist35 = __esm({
    "node_modules/@tiptap/extension-table/dist/index.js"() {
      ...
      markdown_default = renderTableToMarkdown;
      Table = Node3.create({
        name: "table",
        // @ts-ignore
        addOptions() {
